...
For each project, we verify that the project is correctly tested, and passes the tests.
...
The compiler did not fail to compile any of these projects.

Over the 10 successfully compiled projects, the compiler detected 172 callbacks.
...
The details of these results are available in Appendix \ref{section:results}.
