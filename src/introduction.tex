...
This simple and pragmatic compiler has been tested over \textit{n} Github repositories, \textit{k} of which with success. \comment{todo}
...
In section \ref{section:limits}, we present the different steps to automate the application of this equivalence, and expose its limitations.
