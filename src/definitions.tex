...
% Yet programmers must keep in mind the asynchronous flow
...
Such an identification might be possible with a static analysis of the control flow. \comment{todo references}
