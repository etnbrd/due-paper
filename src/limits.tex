...
\comment{more about this, it might need specific paragraphs, and listings}
...
In listing \ref{lst:ct-seq}, because the definitions of \texttt{cont1} and \texttt{cont2} are overlapping, and so are their scopes\ftnt{https://people.mozilla.org/~jorendorff/es6-draft.html\#sec-lexical-environments}.
...
The compiler is limited to the first case.
